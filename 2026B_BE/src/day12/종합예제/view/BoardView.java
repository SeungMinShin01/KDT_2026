...
public class BoardView {
    ...
    public void run() {
        while (true) {
            try {
                ...
                scan = new Scanner(System.in); // 입력(성공) 했지만 타입반환에서 예외 이므로 입력객체 초기화
    ...
    public void save() {
        ...
        String 내용 = scan.next(); // 1.1 저장할 자료 입력받기
    ...
    public void findAll() {
        ArrayList<BoardDto> result = bc.findAll(); // 1. 컨트롤러에게 요청하고 모든 게시물 정보 들을 받는다.
    ...
    public void delete() {
        ...
        if (result) {
            ...
            System.out.println(">삭제 실패(없는 번호)");
        }
    }
}
