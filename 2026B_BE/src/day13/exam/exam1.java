...
public class exam1 {
    public static void main(String[] args) {
        ...
        // 1. toString( ) : 객체의 주소값 반환 함수 , 즉 생략가능 , 활용치 : 오버라이딩 이용한 멤버변수 확인
        System.out.println(o5.toString()); // [I@5ecddf8f
        System.out.println(o5); // [I@5ecddf8f
        Object o6 = new BoardDto(); // toString에 대한 오버라이딩 했음
        System.out.println(o6.toString()); // BoardDto [content=null, writer=null]
        System.out.println(o6); // BoardDto [content=null, writer=null]

        // 2. equals( ) : 객체가 참조하는 값 비교 함수, 활용치: 객체비교, *문자열* 비교
        ...
        System.out.println(str1 == "유재석"); // true 리터럴문자열 == 리터럴 문자열
        System.out.println(str2 == "유재석"); // false 객체(리터럴문자열) == 리터럴문자열
        System.out.println(str2.equals("유재석")); // true
        // 3. hashCode( ) : 객체를 식별하는 값을 정수로 반환 *주수값은16(0~9abcdef)진수
        System.out.println(o6.hashCode()); // 729864207
        System.out.println(o7.hashCode()); // 984849465
        ...
        // 활용처: JDBC(프로그램시작이 아닌 DB 연동시 MYSQL관련 클래스로드 ),
        try {
...
/*
 * 기본타입: byte short int long float doubl char boolean
 * - 리터럴 = 상수
 * 참조타입: 클래스(String Scanner, ~DTO 등), 인터페이스(Connection 등등), 배열 [ ]
 * - 참조 = 주소값
 */
