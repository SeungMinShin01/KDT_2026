...
public class practice2 {
    public static void main(String[] args) {
        ...
        /*
         * [문제 3] 다음과 같은 과일 배열이 있습니다. for 반복문을 사용하여
        ...
        /*
         * [문제 5] 점수 배열에서 100점 만점자가 처음 나타나면, "100점 만점자를 찾았습니다!"라고 출력하고 반복문을 즉시 종료하는
         * 프로그램을 작성하시오.
        ...
        /*
         * [문제 9] 주어진 영화 이름과 평점 배열을 이용하여, 각 영화의 평점을 별(★, ☆)로 시각화하여
         * 출력하는 프로그램을 작성하시오.(*영화명과 평점 인덱스가 같다는 가정 )
        ...
        for (int i = 0; i < movieNames.length; i++) {
            ...
            for (int k = 0; k < 10 - movieRatings[i]; k++) {
                result1 += "☆";
            }
            result1 += "\n";
        }
        ...
        for (int i = 0; i < carNumbers.length; i++) {
            fee1 += (usageMinutes[i] - minute1) / 10 * 500;
            if (minute1 >= usageMinutes[i] - minute1) {
                fee1 = 1000;
            }
            if (fee1 > 20000) {
                fee1 = 20000;
            }
            System.out.printf("%s: %d분주차, 최종 요금: %,d원\n", carNumbers[i], usageMinutes[i], fee1);
        }
    }
}
