...
public class exam1 {
    public static void main(String[] args) {
        ...
        Box5<Integer> box5 = new Box5<>(); // Integer 타입은 Number 타입의 자식 이라서 가능.
...
class Box5<T extends Number> {
    T content;
} // T(제네릭)타입에는 Number 자식 타입만 가능하도록 제약

class Util {
    public static <T> Box3<T> boxing(T 매개변수) {// 메소드의 타입들을 제네릭타입 가능
        Box3<T> box = new Box3();
        box.content = 매개변수;
        return box;
    }
