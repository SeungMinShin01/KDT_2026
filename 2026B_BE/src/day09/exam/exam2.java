...
public class exam2 {
    public static void main(String[] args) {
        ...
        View 인스턴스1 = new View();
        System.out.println(인스턴스1); // View@372f7a8d
        View 인스턴스2 = new View();
        System.out.println(인스턴스2); // View@2f92e0f4
        // 클래스명.getInstance();
        Controller 인스턴스3 = Controller.getInstance();
        System.out.println(인스턴스3);// Controller@5305068a
        Controller 인스턴스4 = Controller.getInstance();
        System.out.println(인스턴스4);// Controller@5305068a
    }
}
