...
public class exam1 {
    public static void main(String[] args) {
         ...
         * ArrayList 클래스:
         * 1. 컬렉션(수집) 프레임워크 , 자료 수집관련 클래스/기능 제공
         * 2. 목적 : 가변길이, 배열 관련된 기능(메소드) 제공한다.
         * 3. 사용법
         * ArrayList<제네릭타입> 변수명 = new ArrayList<>();
         * - 제네릭타입 : 리스트내 저장할 요소들의 타입, 즉] <String> 리스트에 여러개 String 저장
         * - 주의할점: <제네릭타입>은 기본타입이 불가능하다. int -> Integer 래퍼타입 (기본타입을 클래스)
         * 
         * 4. 주요메소드
         * 1. .add(자료) : 리스트 요소 추가
         ...
         * 10. .isEmpty() : 리스트가 비어잆으면 true 아니면 false 반환
         */
        // [1] 리스트 생성
        ...
        변수명1.clear();
        // [12] 리스트 요소 여부 확인
        System.out.println(변수명1.isEmpty()); // 리스트 요소가 하나도 없으면 true
